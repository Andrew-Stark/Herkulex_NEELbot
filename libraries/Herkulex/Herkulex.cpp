...
// add #if defined (__AVR_ATmega328__) if possible for Arduino nano 328, need to find serial port data for this chip, THE INTERNET IS DOWN AND I AM OUT OF HIGH SPEED DATA!! TRULY THERE IS NO HELL DEEPER THAN THIS.
...
void HerkulexClass::setLed(int servoID, byte valueLed)
{
...
byte HerkulexClass::createPacket(byte PID, byte CMD, byte * data)
{
